...
<div id="alert" class="fixed inset-0 flex items-center justify-center z-[9999]">
    ...
    <div class="bg-white rounded-lg shadow-lg p-8 relative w-[70%] md:w-[50%] lg:w-[30%]">
        ...
        <div class="flex flex-col items-center justify-center my-5 px-2">
            <i class="text-red-500 w-16 h-16 stroke-[3px]" data-lucide="x-octagon"></i>
            <h3 class="text-lg md:text-xl font-bold my-2 text-red-500 text-center">Oops!</h3>
            <p class="text-sm md:text-base text-slate-600 font-normal text-center">{!! session()->get('error') !!}</p>
        </div>
