                        ...
                        @forelse ($categories as $index=>$item)
                            <tr class="intro-x">
                                ...
                                <td class="text-center">
                                    ...
                                    <div class="text-slate-500 text-xs whitespace-nowrap mt-0.5">{{ Str::words(html_entity_decode(strip_tags($item->description)), 30, '...') }}</div>
                                </td>
                                    ...
                                    <td class="table-report__action w-56">
                                        <div class="flex justify-center items-center">
                                            ...
                                            <a class="flex items-center text-danger" href="javascript:;" data-tw-toggle="modal" data-tw-target="#delete-confirmation-modal" onclick="deleteHandler({{$index}})"> <i data-lucide="trash-2" class="w-4 h-4 mr-1"></i> Delete </a>
                            ...
                            <div class="modal-body p-0">
                                ...
                                <div class="px-5 pb-8 flex justify-center items-center">
                                    ...
                                    <form id="deleteItem" method="post">
                                        ...
                                        <button type="submit" class="ml-2 btn btn-danger w-24 text-danger">Delete</button>
                                    </form>
