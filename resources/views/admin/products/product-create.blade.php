                    ...
                    <div class="intro-y box p-8">
                        ...
                        <div>
                            ...
                            @error('product_code')
                                <small class="text-xs text-red-500 ml-1">{{ '*' . $message }}</small>
                            @enderror
                            <input id="product_code" name="product_code" type="text" class="new-form-control w-full"
                        ...
                        <div>
                            ...
                            @error('name')
                                <small class="text-xs text-red-500 ml-1">{{ '*' . $message }}</small>
                            @enderror
                            <input id="name" name="name" type="text" class="new-form-control w-full"
                        ...
                        <div>
                            ...
                            @error('dimensions')
                                <small class="text-xs text-red-500 ml-1">{{ '*' . $message }}</small>
                            @enderror
                            <input id="dimensions" name="dimensions" type="text" class="new-form-control w-full"
                        ...
                        <div>
                            ...
                            @error('materials')
                                <small class="text-xs text-red-500 ml-1">{{ '*' . $message }}</small>
                            @enderror
                            <input id="materials" name="materials" type="text" class="new-form-control w-full"
                        ...
                        <div>
                            ...
                            @error('color')
                                <small class="text-xs text-red-500 ml-1">{{ '*' . $message }}</small>
                            @enderror
                            <input id="color" name="color" type="text" class="new-form-control w-full"
                        ...
                        <div>
                            ...
                            @error('price')
                                <small class="text-xs text-red-500 ml-1">{{ '*' . $message }}</small>
                            @enderror
                            <input id="price" name="price" type="text" class="new-form-control w-full"
                        ...
                        <div>
                            ...
                            @error('link_shopee')
                                <small class="text-xs text-red-500 ml-1">{{ '*' . $message }}</small>
                            @enderror
                            <input id="link_shopee" name="link_shopee" type="url" class="new-form-control w-full"
